...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{url('/')}}/assets/vendors/flaticon/flaticon.css">
        <!-- main css -->
            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container box_1620">
						...
						<a class="navbar-brand logo_h" href="index.html"><img src="{{url('/')}}/assets/img/logo.png" alt=""></a>
           	...
           	<div class="container box_1620">
           		<div class="banner_inner d-flex align-items-center">
					<div class="banner_content">
						<div class="media">
							<div class="d-flex">
								<img src="{{url('/')}}/assets/img/personal.jpg" alt="">
							</div>
        	...
        	<div class="container">
        		<div class="gallery_f_inner row imageGallery1">
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{url('/')}}/assets/img/gallery/project-1.jpg" alt="">
        						<a class="light" href="{{url('/')}}/assets/img/gallery/project-1.jpg"><img src="{{url('/')}}/assets/img/gallery/icon.png" alt=""></a>
        					</div>
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{url('/')}}/assets/img/gallery/project-2.jpg" alt="">
        						<a class="light" href="{{url('/')}}/assets/img/gallery/project-2.jpg"><img src="{{url('/')}}/assets/img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 manipul creative design print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{url('/')}}/assets/img/gallery/project-3.jpg" alt="">
        						<a class="light" href="{{url('/')}}/assets/img/gallery/project-3.jpg"><img src="{{url('/')}}/assets/img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative print">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{url('/')}}/assets/img/gallery/project-4.jpg" alt="">
        						<a class="light" href="{{url('/')}}/assets/img/gallery/project-4.jpg"><img src="{{url('/')}}/assets/img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand manipul design">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{url('/')}}/assets/img/gallery/project-5.jpg" alt="">
        						<a class="light" href="{{url('/')}}/assets/img/gallery/project-5.jpg"><img src="{{url('/')}}/assets/img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
        			...
        			<div class="col-lg-4 col-md-4 col-sm-6 brand creative">
        				<div class="h_gallery_item">
        					<div class="g_img_item">
        						<img class="img-fluid" src="{{url('/')}}/assets/img/gallery/project-6.jpg" alt="">
        						<a class="light" href="{{url('/')}}/assets/img/gallery/project-6.jpg"><img src="{{url('/')}}/assets/img/gallery/icon.png" alt=""></a>
        					</div>
        					<div class="g_item_text">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
        ...
        <script src="{{url('/')}}/assets/vendors/counter-up/jquery.counterup.min.js"></script>
